...
/* harmony import */ var _index_vue_vue_type_template_id_4bd6864f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=4bd6864f& */ 43);
...
var _vant = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'vant'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
//
//
//
//
...
var _default = {
  ...
  methods: {
    getUserInfo: function getUserInfo() {
      ...
      wx.getUserInfo({
        success: function success(res) {
          _this.user.avatar = res.userInfo.avatarUrl;
          user.where({
            _openid: wx.cloud.getStorageSync('openid')
            ...
            if (res.data.length === 0) {
              user.add({
                ...
                _this.user._id = res._id;
              });
            } else {
              _this.user.name = res.data[0].name;
    ...
    editNameConfirm: function editNameConfirm() {
      var _this2 = this;
      if (this.editName.trim() === '') {
        _vant.Toast.fail('昵称不能为空');
        return;
      }
      var db = wx.cloud.database();
      var user = db.collection('user');
      user.doc(this.user._id).update({
        ...
        _this2.user.name = _this2.editName;
...
/***/ 49:
/*!**********************************************************************************************************!*\
  !*** C:/Users/程小康/Documents/HBuilderProjects/调课表/pages/mine/index.vue?vue&type=style&index=0&lang=scss& ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
